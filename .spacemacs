...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("JetBrainsMonoNL"
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
   ;; The leader key
